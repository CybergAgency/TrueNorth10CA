          ...
          <div className="row" style={{ marginBottom: '12px' }}>
            <div className="col-md-9 d-flex align-items-center girissozler-wrap mb-2 mb-md-0 pb-2 pb-md-0">
              <div className=" girissozler pr-0 pr-md-5">
                <h1 className="mb-3">Slot machines<img className='title-flag' src={firstSegment=='fi'? fiFlg:firstSegment=='nz'? nzFlg:firstSegment=='ch'? chFlg:caFlg} alt="flag" />
                </h1>
                <p className="mb-3 d-none d-md-block">
                  <b>An overview of the leading online slot machines, featuring detailed insights from experts. This section focuses on popular slots with engaging themes and features, offering players a variety of options for entertaining gameplay. Discover a range of slots to suit different preferences and play styles.  </b>
                </p>
              </div>
            </div>
            <div
