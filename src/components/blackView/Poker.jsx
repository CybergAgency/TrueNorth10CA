          ...
          <div className="row" style={{ marginBottom: '12px' }}>
            <div className="col-md-9 d-flex align-items-center girissozler-wrap mb-2 mb-md-0 pb-2 pb-md-0">
              <div className=" girissozler pr-0 pr-md-5">
                <h1 className="mb-3">Poker<img className='title-flag' src={firstSegment=='fi'? fiFlg:firstSegment=='nz'? nzFlg:firstSegment=='ch'? chFlg:caFlg} alt="flag" />
                </h1>
                <p className="mb-3 d-none d-md-block">
                  <b>
                    Online poker platforms offer a variety of options for both new and experienced players. From classic poker games to modern formats, there are plenty of ways to enjoy this timeless card game. The sites we feature provide a safe and enjoyable environment, secure payment options, and a range of features to suit any playing style.
                  </b>
                </p>
              </div>
            </div>
